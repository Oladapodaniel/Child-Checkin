                ...
                <div class=" container">
                    ...
                    <div class="row">
                        <div class="col-10 offset-1">
                            <button class="btn btn-primary create-btn font-weight-bold w-100 mt-5" @click="toggleLogIn" v-if="!showLogIn && !showSignUp">Log in</button>
...
export default ({
    ...
    setup() {
        ...
        const getChurchProfile = async() => {
            try {
                let res = await axios.get(`/GetChurchProfileById?tenantId=e9749fad-85e8-4130-b553-37acc8acde61`)
                console.log(res)
